...
static void Aux2outAsync(uv_work_t *req)
{
    ...
    // setup inputs
    aux2outPulseMs = baton->aux2outPulseMs;
    aux2outInvert = baton->aux2outInvert ? 1 : 0;

    // run aux2out (blocking)
    uint8_t err = aux2out_pulse(aux2outPulseMs, aux2outInvert);
}
