...
#define AUX_RING_READ() (gpio_get_input(SUNXI_PORT_C_BASE, SUNXI_PIO_05) ? 1 : 0)
...
uint8_t _bulb_init()
{
    ...
    gpio_set_output(SUNXI_PORT_D_BASE, SUNXI_PIO_14);
    gpio_set_output(SUNXI_PORT_D_BASE, SUNXI_PIO_15);

    gpio_cfg_input(SUNXI_PORT_B_BASE, SUNXI_PIO_02_IDX);
    gpio_cfg_input(SUNXI_PORT_B_BASE, SUNXI_PIO_03_IDX);
    gpio_cfg_input(SUNXI_PORT_C_BASE, SUNXI_PIO_05_IDX);
...
uint8_t bulb_read_aux_ring() {
    return AUX_RING_READ();
}
