...
echo "starting UI...";
forever start -f -c "node --max_old_space_size=128" main.js 2>&1 | prepend_date >> $UILOGFILE &
sleep 20
...
echo "starting CORE...";
forever start -f -c "node --max_old_space_size=320" intervalometer/intervalometer-server.js 2>&1 | prepend_date >> $CORELOGFILE &
