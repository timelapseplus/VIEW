...
var UpdateModalContentPage = (function () {
    ...
    UpdateModalContentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-update',template:/*ion-inline-start:"/Users/elijah/VIEW-App/src/pages/intervalometer/update.modal.html"*/'<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      Live Update\n    </ion-title>\n    <ion-buttons start>\n      <button ion-button (click)="dismiss()">\n        <ion-icon name="close"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content no-lines>\n  <ion-grid>\n    <ion-row>\n      <ion-col>\n        <ion-item *ngIf="rampable">\n          <ion-label>{{title}}</ion-label>\n          <button ion-button outline item-end button-light (click)="doNumber(title, intervalometer.program, item)">{{intervalometer.program[item]}}</button>\n        </ion-item>\n        <ion-item *ngIf="rampable">\n          <ion-label>Apply changes</ion-label>\n          <button ion-button outline item-end button-light (click)="doSelect(rampOptions, rampMode, \'frames\', title)">\n            <span *ngIf="rampMode.frames==0">Immediately</span>\n            <span *ngIf="rampMode.frames>0">over {{rampMode.frames}} frames</span>\n          </button>\n        </ion-item>\n      </ion-col>\n      <ion-col>\n        <br>\n        <button ion-button item-end (click)="apply()" [disabled]="intervalometer.program[item]==value?2:2">\n          Apply Change\n        </button>\n        <button ion-button item-end outline (click)="dismiss()">\n          Cancel\n        </button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>\n'/*ion-inline-end:"/Users/elijah/VIEW-App/src/pages/intervalometer/update.modal.html"*/
        }),
