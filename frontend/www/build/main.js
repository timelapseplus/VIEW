...
var RampingModalContentPage = (function () {
    function RampingModalContentPage(viewCtrl, viewApi, alertCtrl, modalCtrl) {
        this.viewCtrl = viewCtrl;
        this.viewApi = viewApi;
        this.alertCtrl = alertCtrl;
        this.modalCtrl = modalCtrl;
...
var KeyframeModalContentPage = (function () {
    ...
    KeyframeModalContentPage.prototype.moveAxis = function (axisId, speed) {
        ...
        if (axisId == 'focus') {
            ...
            if (speed > 1)
                speed = 1;
            if (this.axes[axisId].motor.name == 'Tilt')
                speed = 0 - speed; // tilt is normally reversed
