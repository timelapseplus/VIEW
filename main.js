...
app.on('message', function(msg) {
    ...
    try {
        switch(msg.type) {
            ...
            case 'run':
                core.loadProgram(msg.program);
                core.startIntervalometer(msg.program, msg.date, msg.utcOffset);
                break;
...
//img116x70, isoText, apertureText, shutterText, intervalSeconds, intervalModeChar, hist60, ramp30, frames, remaining, durationSeconds, bufferSeconds, shutterSeconds
    ...
    var statusScreen = {
        ...
        apertureText: (msg.cameraSettings.details && msg.cameraSettings.details.aperture) ? ("f/" + msg.cameraSettings.details.aperture) : ("f/" + lists.getNameFromEv(lists.aperture, core.currentProgram.manualAperture) + ' (m)'),
        evText: evText + " EV",
