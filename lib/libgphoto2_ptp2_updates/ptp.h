...
#define PTP_VENDOR_PANASONIC	0x0000001c /* observed in the Panasonic DC-GH5 */
...
#define PTP_OC_PANASONIC_9102			 	0x9102
#define PTP_OC_PANASONIC_9107			 	0x9107
#define PTP_OC_PANASONIC_Liveview		 	0x9412
#define PTP_OC_PANASONIC_LiveviewImage   	0x9706
#define PTP_OC_PANASONIC_PollEvents			0x9414
...
uint16_t ptp_getfilesystemmanifest (PTPParams* params, uint32_t storage,
                        ...
                        unsigned char** data);
uint16_t ptp_setdevicepropvalue_raw (PTPParams* params, uint16_t propcode,
