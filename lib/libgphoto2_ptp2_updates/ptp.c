		...
		*events = calloc(*count, sizeof(uint16_t));
		if(*events && size >= 2 + *count * 6)
		{
			...
			for(i = 0; i < *count; i++)
			{
				...
				//memcpy(*events + (i * sizeof(uint16_t)), &param, sizeof(uint16_t));
				if(param == 0xd20d) *events[i] = param;
...
ptp_olympus_omd_init(PTPParams* params)
{
	PTPContainer	ptp;
	uint16_t	ret;
	char init_9489[] = {};
	char init_948b[] = {0x10,0x00,0x00,0x00,0x57,0xD0,0x5C,0xD0,0x5D,0xD0,0x5E,0xD0,0x74,0xD0,0x75,0xD0,0x85,0xD0,0xD0,0xD0,0xD1,0xD0,0xD2,0xD0,0xD3,0xD0,0xED,0xD0,0xE1,0xD0,0x84,0xD0,0x79,0xD0,0x64,0xD0};

	PTP_CNT_INIT(ptp, 0x9489);
	ptp_transaction(params, &ptp, PTP_DP_SENDDATA, sizeof(init_9489), &init_9489, NULL);
	PTP_CNT_INIT(ptp, 0x948b);
	return ptp_transaction(params, &ptp, PTP_DP_SENDDATA, sizeof(init_948b), &init_948b, NULL);
}
...
ptp_generic_getdevicepropdesc (PTPParams *params, uint16_t propcode, PTPDevicePropDesc *dpd)
{
	...
	//if (	(params->deviceinfo.VendorExtensionID == PTP_VENDOR_FUJI) )
 	//{
	//	CHECK_PTP_RC(ptp_fuji_getevents (params));
	//	//for (i=0;i<params->nrofdeviceproperties;i++)
	//	//	if (params->deviceproperties[i].desc.DevicePropertyCode == propcode)
	//	//		break;
	//	//if (i == params->nrofdeviceproperties) {
