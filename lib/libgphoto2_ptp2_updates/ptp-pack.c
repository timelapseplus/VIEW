...
/* Device Property pack/unpack */
#define PTP_dpd_Panasonic_HeaderLength	0
#define PTP_dpd_Panasonic_CurrentValue	1
#define PTP_dpd_Panasonic_Count			2
#define PTP_dpd_Panasonic_List			2

static inline int
ptp_unpack_Panasonic_DPD (PTPParams *params, unsigned char* data, PTPDevicePropDesc *dpd, unsigned int dpdlen, unsigned int *poffset)
{
	unsigned int ret;
#if 0
	unsigned int unk1, unk2;
