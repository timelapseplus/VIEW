...
cd $WDIR
/bin/echo "{ global:" > _libs/ptp2.ver
cat ../camlibs/camlib.sym | sed -e "s/\(.*\)/\1;/" >> _libs/ptp2.ver
/bin/echo "local: *; };" >> _libs/ptp2.ver


cd $WDIR
/usr/bin/gcc -shared  -fPIC -DPIC  ptp2/_libs/ptp2_la-ptp.o ptp2/_libs/ptp2_la-library.o ptp2/_libs/ptp2_la-usb.o ptp2/_libs/ptp2_la-ptpip.o ptp2/_libs/ptp2_la-config.o ptp2/_libs/ptp2_la-olympus-wrap.o ptp2/_libs/ptp2_la-chdk.o   -L/usr/local/lib -lgphoto2 -lgphoto2_port  -O2 -O2   -Wl,-soname -Wl,ptp2.so -Wl,-version-script -Wl,_libs/ptp2.ver -o _libs/ptp2.so
...
PATH="/root/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/sbin" /sbin/ldconfig -n /usr/local/lib/libgphoto2/2.5.11.1
