...
var properties = {
    ...
    'evfout': {
        ...
        code: 0xD1B0,
        values: [
            { name: "Unknown",   value: "zero",        code: 0  },
            { name: "TFT",       value: "tft",         code: 1  },
            { name: "PC",        value: "pc",          code: 2  },
            { name: "Off",       value: "off",         code: 3  },
            { name: "Unknown4",  value: "u4",          code: 4  },
            { name: "Unknown5",  value: "u5",          code: 5  },
            { name: "Unknown6",  value: "u6",          code: 6  },
            { name: "Unknown7",  value: "u7",          code: 7  },
            { name: "Unknown8",  value: "u8",          code: 8  },
            { name: "Unknown9",  value: "u9",          code: 9  },
            { name: "UnknownA",  value: "uA",          code: 10  },
            { name: "UnknownB",  value: "uB",          code: 11  },
        ],
        ev: false,
    },
    'focusMode': {
...
function getImage(camera, timeout, callback) {
    ...
    var check = function() {
        ...
        pollEvents(camera, function(err) { // check events
...
driver.liveviewImage = function(camera, callback, _tries) {
    ...
    if(camera.status.liveview) {
        ptp.transaction(camera._dev, 0x9153, [0x00200000, 0, 0], null, function(err, responseCode, data) {
            if(!err && data) {
                var index = 0;
