...
lists.apertureAll = [{
    ...
    name: "3.8",
    ev: -4.25,
    values: ['3.8', 'f/3.8', 'f3.8']
}, {
    name: "4",
    ev: -4,
    values: ['4', 'f/4', 'f4', 'f4.0', '4.0']
}, {
    name: "4.2",
    ev: -3.75,
    values: ['4.2', 'f/4.2', 'f4.2', 'f4.2', '4.2']
}, {
    name: "4.5",
    ev: -3 - 2 / 3,
...
lists.shutterAll = [{
    ...
    name: "3s",
    ev: -7 - 2 / 3,
    values: ['32/10', '3', '3.2', '3.2000s', '3.2"']
}, {
    name: "3s",
    ev: -7.5,
    ...
    name: "1.6s",
    ev: -6 - 2 / 3,
    values: ['16/10', '1.6', '1.6000s', '1.6"']
}, {
    name: "1.5s",
    ev: -6.5,
    values: ['15/10', '1.5', '1.5000s', '1.5"']
}, {
    name: "1.3s",
    ev: -6 - 1 / 3,
    values: ['13/10', '1.3', '1.3000s', '1.3"']
}, {
    name: "1s",
    ev: -6,
    ...
    name: "0.8s",
    ev: -5 - 2 / 3,
    values: ['8/10', '0.8', '10/13', '0.7692s', '0.8"']
}, {
    name: "0.7s",
    ev: -5.5,
    values: ['7/10', '0.7', '10/15', '0.7000s', '0.7"']
}, {
    name: "0.6s",
    ev: -5 - 1 / 3,
    values: ['6/10', '0.625', '0.6', '10/16', '0.6250s', '0.6"']
}, {
    name: "1/2",
    ev: -5,
    values: ['5/10', '0.5', '1/2', '0.5000s', '0.5"']
}, {
    name: "0.4s",
    ev: -4 - 2 / 3,
    values: ['4/10', '0.4', '10/25', '0.4000s', '0.4"']
}, {
    name: "1/3",
    ev: -4.5,
