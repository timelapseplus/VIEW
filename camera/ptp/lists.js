...
//    name: "60s",
//    ev: -12,
//    values: ['64000000', '-2147423648']
//}, {
//    name: "50s",
//    ev: -11 - 2 / 3,
//    values: ['50796833', '-2147433648']
//}, {
//    name: "40s",
//    ev: -11 - 1 / 3,
//    values: ['40317473', '-2147443648']
}, {
    name: "30s",
    ev: -11,
    values: ['300/10', '30', '30.0000s', '30"', '32000000', '-2147453648']
}, {
    name: "25s",
    ev: -10 - 2 / 3,
    values: ['250/10', '25', '25.0000s', '25"', '25398416', '-2147458648']
}, {
    name: "24s",
    ev: -10.5,
    ...
    name: "20s",
    ev: -10 - 1 / 3,
    values: ['200/10', '20', '20.0000s', '20"', '20158736', '-2147463648']
}, {
    name: "15s",
    ev: -10,
    values: ['150/10', '15', '15.0000s', '15"', '16000000', '-2147468648']
}, {
    name: "13s",
    ev: -9 - 2 / 3,
    values: ['130/10', '13', '13.0000s', '13"', '12699208', '-2147470648']
}, {
    name: "12s",
    ev: -9.5,
    ...
    name: "10s",
    ev: -9 - 1 / 3,
    values: ['100/10', '10', '10.0000s', '10"', '10079368', '-2147473648']
}, {
    name: "8s",
    ev: -9,
    values: ['80/10', '8', '8.0000s', '8"', '8000000', '-2147475648']
}, {
    name: "6s",
    ev: -8 - 2 / 3,
    values: ['60/10', '6', '6.0000s', '6"', '6349604', '-2147477648']
}, {
    name: "6s",
    ev: -8.5,
    ...
    name: "5s",
    ev: -8 - 1 / 3,
    values: ['50/10', '5', '5.0000s', '5"', '5039684', '-2147478648']
}, {
    name: "4s",
    ev: -8,
    values: ['40/10', '4', '4.0000s', '4"', '4000000', '-2147479648']
}, {
    name: "3s",
    ev: -7 - 2 / 3,
    values: ['32/10', '3', '3.2', '3.2000s', '3.2"', '3,2"', '3174802', '-2147480448']
}, {
    name: "3s",
    ev: -7.5,
    ...
    name: "2.5s",
    ev: -7 - 1 / 3,
    values: ['25/10', '2.5', '2.5000s', '2.5"', '2,5"', '2519842', '-2147481148']
}, {
    name: "2s",
    ev: -7,
    values: ['20/10', '2', '2.0000s', '2"', '2000000', '-2147481648']
}, {
    name: "1.6s",
    ev: -6 - 2 / 3,
    values: ['16/10', '1.6', '1.6000s', '1.6"', '1,6"', '1414213', '-2147482048']
}, {
    name: "1.5s",
    ev: -6.5,
    ...
    name: "1.3s",
    ev: -6 - 1 / 3,
    values: ['13/10', '1.3', '1.3000s', '1.3"', '1,3"', '1259921', '-2147482348']
}, {
    name: "1s",
    ev: -6,
    values: ['10/10', '1', '1.0000s', '10/10', '1"', '1000000', '-2147482648']
}, {
    name: "0.8s",
    ev: -5 - 2 / 3,
    values: ['8/10', '1/1.3', '0.8', '10/13', '0.7692s', '0.8"', '0,8"', '793700']
}, {
    name: "0.7s",
    ev: -5.5,
    ...
    name: "0.6s",
    ev: -5 - 1 / 3,
    values: ['6/10', '1/1.6', '0.625', '0.6', '10/16', '0.6250s', '0.6"', '0,6"', '629960']
}, {
    name: "1/2",
    ev: -5,
    ...
    name: "0.4s",
    ev: -4 - 2 / 3,
    values: ['4/10', '1/2.5', '0.4', '10/25', '0.4000s', '0.4"', '0,4"', '396850']
}, {
    name: "1/3",
    ev: -4.5,
    ...
    name: "1/3",
    ev: -4 - 1 / 3,
    values: ['1/3', '1/3.2', '0.3', '0.3125s', '314980']
}, {
    name: "1/4",
    ev: -4,
